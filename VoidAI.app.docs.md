...
messages\=\[
       ...
       {"role": "user", "content": "What's the history of artificial intelligence?"}

\]

)

_print_(response.choices\[0\].message.content)
...
_for_ model _in_ models.data:  
 _print_(f"ID: {model.id}, Owner: {model.owned_by}")
...
_\# Initialize the client with your API key_
...
model\="claude-3-5-sonnet-20241022", _\# An Anthropic model_

messages\=messages

)

_\# Extract and print the response_

assistant_response \= response.choices\[0\].message.content

_print_(assistant_response)
...
_\# Start with a system message_

system_prompt \= input("Set your system prompt: ")

messages \= \[{"role": "system", "content": system_prompt}\]

_print_("Starting the chat. Type 'exit' to end the conversation.")

_\# Main conversation loop_

_while_ True:

user_input \= input("You: ")

_if_ user_input.lower() \== 'exit':

       *print*("Ending the conversation.")

       *break*

_\# Add the user's message and get a response_
...
_\# Add the assistant's response to the conversation history_

messages.append({"role": "assistant", "content": assistant_response})

_print_(f"Assistant: {assistant_response}")

## **Advanced Parameters[ ](https://docs.voidai.app/docs/text-generation#advanced-parameters)**
...
_print_("OpenAI response:", openai_response.choices\[0\].message.content)

_print_("Google response:", google_response.choices\[0\].message.content)
...
### **More Advanced Image Generation[ ](https://docs.voidai.app/docs/image-generation#more-advanced-image-generation)**
...
_\# Get the image URL_  
image_url \= response.data\[0\].url

_\# Download the image_  
...
_print_(completion.choices\[0\].message.content)

_\# Save the audio response_

wav_bytes \= base64.b64decode(completion.choices\[0\].message.audio.data)

_with_ open("response.wav", "wb") _as_ f:

f.write(wav_bytes)

## **Supported Voices[ ](https://docs.voidai.app/docs/audio-generation#supported-voices)**

The audio generation supports several voice options:

- alloy \- A neutral voice with balanced tone
- echo \- A deeper, more authoritative voice
- fable \- A soft, friendly voice with warmth
- nova \- A professional, clear voice
- shimmer \- A bright, energetic voice

## **Supported Audio Formats[ ](https://docs.voidai.app/docs/audio-generation#supported-audio-formats)**

You can request audio output in the following formats:

- wav \- High quality uncompressed audio
- mp3 \- Compressed audio with good quality and smaller file size
- opus \- Optimized for voice applications with low bandwidth
...
_\# Initial request with audio response_
...
_print_(second_response.choices\[0\].message.content)

## **Limitations and Considerations[ ](https://docs.voidai.app/docs/audio-generation#limitations-and-considerations)**
...
speech_file_path \= Path(\_\_file\_\_).parent / "speech.mp3"
...
### **Basic Text-to-Speech[ ](https://docs.voidai.app/docs/text-to-speech#basic-text-to-speech)**
...
_\# Stream to file as chunks are received_

response.stream_to_file("streaming_output.mp3")

## **Supported Output Formats[ ](https://docs.voidai.app/docs/text-to-speech#supported-output-formats)**
...
## **Advanced Usage Tips[ ](https://docs.voidai.app/docs/text-to-speech#advanced-usage-tips)**
...
### **Pronunciation Control[ ](https://docs.voidai.app/docs/text-to-speech#pronunciation-control)**
...
### **Performance Optimization[ ](https://docs.voidai.app/docs/speech-to-text#performance-optimization)**
