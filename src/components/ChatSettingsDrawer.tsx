...
import {
    Drawer, Box, Typography, TextField, Slider, IconButton, InputAdornment, Tooltip
} from '@mui/material';
...
export const ChatSettingsDrawer: React.FC<ChatSettingsDrawerProps> = ({ open, onClose }) => {
    ...
    const onTextFieldChange = (event: React.ChangeEvent<HTMLInputElement | HTMLTextAreaElement>, handler: (value: string) => void) => {
    ...
    return (
        <Drawer anchor="right" open={open} onClose={onClose}>
            <Box sx={{ width: 300, p: 2, display: 'flex', flexDirection: 'column', height: '100%' }}>
                ...
                <Box sx={{ mb: 3 }}>
                    <Tooltip title="Your OpenRouter API Key. Stored locally in your browser." placement="top">
                        <TextField
                            fullWidth
                ...
                <Box sx={{ mb: 3 }}>
                    ...
                    <Tooltip title="Controls randomness. Lower values are more deterministic." placement="top">
                        <Slider
                            value={temperature}
                ...
                <Box sx={{ mb: 3, flexGrow: 1, display: 'flex', flexDirection: 'column' }}>
                    ...
                    <Tooltip title="Instructions for the AI model's behavior." placement="top">
                        <TextField
                            fullWidth
                            label="System Prompt"
                            variant="outlined"
                ...
                <Box sx={{ mt: 'auto', pt: 2, borderTop: 1, borderColor: 'divider' }}>
                    <Typography variant="body2" color="text.secondary">
                        Total Tokens (Current Chat): {/* TODO: Connect to token count store */} 0
                    </Typography>
                </Box>
            </Box>
        </Drawer>
