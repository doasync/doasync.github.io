...
import { appStarted, newChatCreated, $currentChatSession, generateTitleFx } from '@/model/history'; // Import history events and stores
                ...
                <Box sx={{ position: 'relative' }}>
                  ...
                  >
                    <IconButton
                      ...
                      title="Copy"
                    >
                      <svg width="16" height="16"><path fill="currentColor" d="M3 2a1 1 0 0 0-1 1v11a1 1 0 0 0 1 1h7a1 1 0 0 0 1-1V9h-1v4H4V4h4V3H3zm9-1h-3v1h2.293L8 6.293 8.707 7 13 2.707V5h1V1a1 1 0 0 0-1-1z"/></svg>
                    </IconButton>
                    <IconButton
                      size="small"
                      onClick={() => {
                      ...
                      title="Edit"
                    >
                      <svg width="16" height="16"><path fill="currentColor" d="M12.146 2.854a.5.5 0 0 1 .708 0l.292.292a.5.5 0 0 1 0 .708l-9 9L3 13l.146-.146 9-9zM2 12.5V14h1.5l.146-.146-1.5-1.5L2 12.5z"/></svg>
                    </IconButton>
                    <IconButton
                      size="small"
                      onClick={() => {
                      ...
                      title="Delete"
                    >
                      <svg width="16" height="16"><path fill="currentColor" d="M5.5 5a.5.5 0 0 1 .5.5V12a.5.5 0 0 1-1 0V5.5a.5.5 0 0 1 .5-.5zm2.5.5a.5.5 0 0 0-1 0V12a.5.5 0 0 0 1 0V5.5zm2 .5a.5.5 0 0 1 .5-.5V12a.5.5 0 0 1-1 0V5.5z"/><path fill="currentColor" d="M14.5 3a1 1 0 0 1-1 1H13v9a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V4h-.5a1 1 0 0 1 0-2h3.086A1.5 1.5 0 0 1 7 1h2a1.5 1.5 0 0 1 1.414 1H13.5a1 1 0 0 1 1 1zm-3 1H4v9a1 1 0 0 0 1 1h6a1 1 0 0 0 1-1V4zM5 2a.5.5 0 0 0-.5.5V3h7v-.5a.5.5 0 0 0-.5-.5h-6z"/></svg>
                    </IconButton>
                    <IconButton
                      size="small"
                      onClick={() => {
                      ...
                      title="Retry"
                    >
                      <svg width="16" height="16"><path fill="currentColor" d="M8 3a5 5 0 1 1-4.546 2.914.5.5 0 1 1 .908-.418A4 4 0 1 0 8 4v1.5a.5.5 0 0 1-1 0V3.5a.5.5 0 0 1 .5-.5H9a.5.5 0 0 1 0 1H8z"/></svg>
                    </IconButton>
                  </Box>
                </Box>
              </Paper>
