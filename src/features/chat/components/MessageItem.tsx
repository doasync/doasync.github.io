...
import { FileAttachmentWrapper } from '@/features/document-processing/components/FileAttachmentWrapper';
...
import { MarkdownRenderer } from '@/features/ui-core/components/MarkdownRenderer';
                  ...
                  {attachmentParts.map((part, contentIndex) => {
                    if (part.type === 'image_url') {
                      ...
                      if (attachment) {
                        ...
                        // Add content metrics
                        const wordCount =
                          documentPart.document.metadata.wordCount;
