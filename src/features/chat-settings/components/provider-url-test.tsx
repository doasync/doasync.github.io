        ...
        <Tooltip
          title={
            urlTestResult?.success
              ...
              : (() => {
                  if (apiKey.trim()) {
                    return 'Test if the provider URL is accessible and returns valid models (using current API key)';
                  }
                  return 'Test if the provider URL is accessible and returns valid models (no API key set - some providers may require authentication)';
                })()
          }
        >
          <Button
