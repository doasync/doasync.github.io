...
import { duplicateChatClicked, newChatCreated } from '../model';
...
import type { ChatHistoryIndex } from '../types';
import MoreVertIcon from '@mui/icons-material/MoreVert';
import ContentCopyIcon from '@mui/icons-material/ContentCopy';
import RefreshIcon from '@mui/icons-material/Refresh';
import { regenerateTitleForChat } from '../model';
...
const ChatHistoryContent: React.FC<ChatHistoryPanelProps> = ({
  searchTerm,
  setSearchTerm,
  isLoading,
  filteredHistory,
